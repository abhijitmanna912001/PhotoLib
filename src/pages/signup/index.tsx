...
export default function Signup() {
  ...
  return (
    <div className="bg-slate-800 w-screen h-screen flex items-center justify-center px-4">
      <div className="flex flex-col lg:flex-row w-full max-w-6xl bg-card rounded-xl overflow-hidden shadow-lg h-full max-h-[95vh] lg:h-auto">
        ...
        {/* Right side form */}
        <div className="flex-1 flex items-center justify-center p-2 sm:p-4 lg:p-6 overflow-y-auto">
